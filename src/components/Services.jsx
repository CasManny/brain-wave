    ...
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] border mb-5 p-8 border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating
              className={
                "absolute left-4 right-4 bottom-4 border-n-1/10 lg:left-1/2 lg:right-auto lg:-translate-x-1/2"
              }
            />
          </div>
