...
const Hero = () => {
  ...
  return (
    ...
    >
          ...
          <div className="relative z-1 p-0 5 rounded-2xl bg-conic-gradient">
            ...
            <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
              ...
              <ScrollParallax isAbsolutelyPositioned>
                <ul className="hidden absolute -left-[5.5rem] bottom-[7.5rem] px-1 py-1 bg-n-9/40 border-n-1/10 rounded-2xl xl:flex">
                  {heroIcons.map((icon, index) => (
                    <li className="p-5" key={index}>
                      <img src={icon} alt="heroicon" width={25} height={25} />
                    </li>
                  ))}
                </ul>
              </ScrollParallax>
      ...
      <CompanyLogos className='hidden relative z-50 mt-20 lg:block' />
      <BottomLine />
    </Section>
  );
};
